    ...
    <nav className="p-5 bg-white shadow md:flex md:items-center md:justify-between">
      ...
      <ul className="md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
        <li className="mx-4 my-6 md:my-0">
          <a href="DashboardKasir" className="text-xl hover:text-cyan-500 duration-500">
        ...
        <li className="mx-4 my-6 md:my-0">
          <a href="Transaksi" className="text-xl hover:text-cyan-500 duration-500">
            <div className="text-xl">
              <BsClockHistory />
            </div>
            History
        ...
        <li className="mx-4 my-6 md:my-0">
          <a href="TambahTransaksi" className="text-xl hover:text-cyan-500 duration-500">
            <div className="text-xl">
              <IoCardOutline />
            </div>
            Transaksi
